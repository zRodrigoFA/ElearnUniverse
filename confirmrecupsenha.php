...
<head>
    ...
    <title>eLearnUniverse :: Instruções Enviadas</title>
</head>
    ...
    <div class="d-flex flex-column wrapper">
        ...
        <main class="flex-fill">
            ...
            <div class="container text-info">
                <h1 class="text-decoration-underline">Instruções Enviadas!</h1>
                <hr>
                <p>
                    Caro cliente,
                </p>
                <p>
                    ...
                    <b class="text-decoration-underline">email@dominio.com.br</b>. Abra a mensagem que lhe enviamos e siga as instruções corretamente para cadastrar uma nova senha.
                </p>
                <p>
                    Agradecemos pela confiança em nossos serviços.
                </p>
                <p>
                    Cordialmente,<br> Central de Relacionamento eLearnUniverse
                </p>
                <p>
                    <a href="index.php" class="btn btn-lg btn-dark text-bg-info">Voltar à Página Principal</a>
                </p>

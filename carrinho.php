...
<head>
    ...
    <title>eLearnUniverse:: Carrinho de Compras</title>
</head>
...
<body>
    ...
    <?php if (isset($_SESSION['carrinho']) && count($_SESSION['carrinho']) > 0) : ?>
        <ul class="list-group mb-3">
                ...
                <li class="list-group-item py-3">
                    <div class="row g-3">
                        ...
                        <div class="col-8 col-md-9 col-lg-7 col-xl-8 align-self-center">
                            <h4><b><a href="#" class="text-decoration-none text-bg-info"><?php echo $produto['nome']; ?></a></b></h4>
            ...
            <li class="list-group-item py-3">
                <div class="text-end">
                    <h4 class="text-dark text-bg-white mb-3">
                        Valor total: R$<?php echo calcularTotalCarrinho($_SESSION['carrinho']); ?>
                    </h4>
                    <a href="index.php" class="btn btn-outline-dark btn-lg">
                        Continuar Comprando
                    </a>
                    <a href="carrinho.php?finalizado=true" class="btn btn-outline-dark btn-lg ms-2 mt-xs-3">
                        Fechar Compra
                    </a>
    ...
    <?php else : ?>
        <p class="text-info"><a href="index.php"> carrinho está vazio.</a></p>
    <?php endif; ?>
</div>
        </div>
    </main>

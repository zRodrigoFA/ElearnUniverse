            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse ">
                    ...
                    <div class="align-self-end">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a href="cadastro.php" class="nav-link text-info"><?php echo "Olá, "; echo $_SESSION['user_nome']; ?></span>
    </a>
                            </li>
                            <li class="nav-item">
                                <a href="logout.php" class="nav-link text-info">Sair</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="col-12 col-md-5">
                        <form class="justify-content-center text-dark mb-3 mb-md-0" method="GET">
                            <div class="input-group input-group-sm">
                                ...
                                <button class="btn btn-lg btn-dark text-bg-info">Buscar </button>
                            </div>
                        </form>
                    </div>
                    <div class="col-12 col-md-7">
                        <div class="d-flex flex-row-reverse justify-content-center justify-content-md-start">
                            <form class="d-inline-block " method="GET">
                                ...
                                <button type="submit" class="btn btn-lg btn-dark text-bg-info">Ordenar</button>
                            </form>
...
while ($row = $result->fetch_assoc()) {
    ...
    echo "<div class='card text-center text-info bg-black'>";
    ...
    echo "<li class='list-group-item text-info bg-black'>$nome</li>";
    echo "<li class='list-group-item text-info bg-black'>$tipo</li>";
    echo "<li class='list-group-item text-info bg-black'>$tempo</li>";
    echo "<li class='list-group-item text-info bg-black'>Preço: $preco</li>";
    echo "</ul>";
    ...
    echo "<button type='submit' name='adicionar_carrinho' class='btn btn-lg btn-dark mt-2 text-bg-info'>Adicionar ao carrinho</button>";
    echo "</form>";
    echo "</div>";
    echo "</div>";
    echo "</div>";

        ...
        if (empty($email) || empty($senha)) {
            ...
            if ($result && $result->num_rows > 0) {
                ...
                if (password_verify($senha, $row['senha'])) {
                    ...
                    $_SESSION['login_error'] = "Falha ao logar! E-mail ou senha incorretos.";
                }
            } else {
                $_SESSION['login_error'] = "Falha ao logar! E-mail ou senha incorretos.";
            }
...
<head>
    ...
    <title>eLearnUniverse:: Login</title>
</head>
    ...
    <div class="d-flex flex-column wrapper">
            ...
            <div class="container text-info">
                <div class="row justify-content-center">
                    <form class="col-sm-10 col-md-8 col-lg-6 " method="POST" action="">
                        <h1 class="text-decoration-underline">Identifique-se, por favor</h1>
                        ...
                        <div class="form-floating mb-3 text-dark">
                            <input type="email" id="email" class="form-control" placeholder=" " autofocus="" name="email">
                        ...
                        <button type="submit" class="btn btn-lg btn-dark text-bg-info">Entrar</button>

                        <p class="mt-3 ">
                            Ainda não é cadastrado? <a class="text" href="cadastro.php">Clique aqui</a> para se cadastrar.
                        </p>

                        <p class="mt-3">
                            Esqueceu sua senha? <a class="text" href="recuperarsenha.php">Clique aqui</a> para recuperá-la.
                        </p>
                    </form>
                </div>
            </div>
        ...
        <footer class="bg-dark text-white text-center">
            <div class="container py-3">
                <p class="mb-0">Desenvolvido por <a href="https://www.eLearnUniverse.com">eLearnUniverse</a></p>
            </div>
        </footer>
    </div>

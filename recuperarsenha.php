...
<head>
    ...
    <title>eLearnUniverse:: Reuperação de Senha</title>
</head>
            ...
            <div class="container text-info">
                <div class="row justify-content-center ">
                    <form class="col-sm-10 col-md-8 col-md-6 ">
                        ...
                        <button type="button" onclick="window.location.href='confirmrecupsenha.php'" class="btn btn-lg btn-dark text-bg-info">Recuperar Senha</button>
                        <p classs=" mt-3 ">

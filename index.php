        ...
        <div class="container">
            <div id="carouselMain" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item" data-bs-interval="3000">
                        <img src="img/banner5.jpeg" class="d-none d-md-block w-100" alt="">
                    ...
                    <div class="col-12 col-md-7">
                        <div class="d-flex flex-row-reverse justify-content-center justify-content-md-start">
                            <form class="d-inline-block" method="GET">
                                ...
                                <button type="submit" class="btn btn-dark text-bg-info">Ordenar</button>
                            </form>
                        </div>
                    </div>
                </div>
...
while ($row = $result->fetch_assoc()) {
    ...
    echo "<a href='login.php' class='btn btn-lg btn-dark mt-2 text-bg-info'>Adicionar ao carrinho</a>";
    echo "</div>";
    echo "</div>";
    echo "</div>";
    echo "</div>";
            ...
            <div class="container ">
                <div class="row py-3 ">
                    <div class="col-12 col-md-4 text-center text-info">
                         ©2023 -eLearnUniverse Ltda ME<br>

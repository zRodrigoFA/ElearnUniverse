...
<head>
    ...
    <title>eLearnUniverse:: Política de Cancelamento</title>
</head>
    ...
    <div class="d-flex flex-column wrapper">
        ...
        <main class="flex-fill">
            ...
            <div class="container text-info">
                <h1 class="text-decoration-underline">Política de Trocas e Devoluções</h1>
                <hr>
                <p>
                    A eLearnUniverse utiliza tecnologia de ponta para a fabricação de seus produtos, primando pela qualidade e satisfação de seus clientes. Pelo respeito e para que seja mantida a credibilidade conquistada junto aos seus consumidores, a empresa criou uma política
                    de troca e devolução de acordo com o Código de Defesa do Consumidor, e preocupada para que você (cliente) obtenha uma negociação eficaz, ágil e principalmente satisfatória.
                </p>
                <p>
                ...
                <p >
                    Caso receba algum produto com o código conrrompido, entre em contato imediatamente.
                </p>
                <p >
                ...
                <h5 class=" text-decoration-underline ">Devolução por Arrependimento/Desistência</h5>
                <p >
